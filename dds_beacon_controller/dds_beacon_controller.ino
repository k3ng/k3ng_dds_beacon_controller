...
// #define FEATURE_SOFTWARE_SERIAL

//#define DEBUG

#if defined(FEATURE_DDS_TX)
  #include <dds.h>
#endif

#if defined(FEATURE_SOFTWARE_SERIAL)
  #include <SoftwareSerial.h>
#endif

#if defined(FEATURE_RIG_CONTROL)
  #include <k3ng_rig_control.h>
#endif

#define rig_control_rx 2
#define rig_control_tx_3
...
enum unit_mode_type {OFFLINE, MAINTENANCE, BEACON};
...
byte char_send_mode = SEND_MODE_CW;
  ...
  if (keyer_is_idle() && unit_mode == BEACON) {
    ...
    switch (sequence) {
      case 1:
        ...
        send_character_string((char*)"K3NG/B");
        sequence++;
        break;
      case 2:
        switch_to_tx(2);
      ...
      case 3:
        switch_to_tx(1);
        sidetone_mode = SIDETONE_ON;
        send_character_string((char*)"FN20");
        sequence++;
        break;
      case 4:
        switch_to_tx(2);
...
//  #endif
  ...
  switch(transmitter) {
    case 1:
      ...
      #ifdef FEATURE_DDS_TX
        ddschip.setfrequency(25005000LL);
      #endif
    ...
    case 2:
      #ifdef FEATURE_DDS_TX
        ddschip.setfrequency(28291500LL);
      #endif
...
void send_char(char cw_char, byte omit_letterspace)
{
  ...
  if (char_send_mode == SEND_MODE_CW) {
    switch (cw_char) {
